  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-10 sm:grid-cols-[minmax(0,1fr)_minmax(0,360px)] sm:items-start">
          ...
          <div className="flex flex-col gap-6 text-sm text-gray-700">
            ...
            <span className="text-xs text-gray-500">© {year} Vokal Digital</span>
          </div>
          ...
          <form action="/contact" className="w-full rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="h-11 flex-1 rounded-full border border-gray-300 bg-white px-4 text-sm text-gray-900 placeholder-gray-400 shadow focus:border-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900/10"
              />
              <button
                type="submit"
                className="flex h-11 items-center gap-3 rounded-full border border-gray-900 bg-gray-900 px-4 text-sm font-medium text-white transition-colors hover:bg-black"
              >
                Let’s talk
