          ...
          <div className="relative z-[80] flex items-center justify-between rounded-2xl bg-black/30 px-5 py-2.5 backdrop-blur-[9px] sm:px-6">
            ...
            <nav className="hidden items-center gap-8 text-sm md:flex md:text-base" aria-label="Primary">
              ...
              <div className="flex items-center gap-3 pl-6">
                <Link
                  href="/login"
                  className="inline-flex w-fit items-center justify-center rounded-2xl border border-white/80 px-4 py-2 text-sm font-medium text-white transition-colors hover:border-white hover:bg-white/10"
                >
                  Log in
                </Link>
                <Link
